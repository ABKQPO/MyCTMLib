...
public class MyCTMLibMetadataSectionSerializer implements IMetadataSectionSerializer {
    ...
    public static class MyCTMLibMetadataSection implements IMetadataSection {
        ...
        public boolean isBeeJsonModelsEnabled() {
            return Boolean.TRUE.equals(getBeeJsonModelsEnabledSetting());
        }

        public Boolean getBeeJsonModelsEnabledSetting() {
            return getBooleanSetting("enableBeeJsonModels");
        }

        public Boolean getAe2JsonModelsEnabledSetting() {
            return getBooleanSetting("enableAe2JsonModels");
        }
        ...
        public Boolean getBooleanSetting(String key) {
            ...
            if (!json.getAsJsonPrimitive(key)
                .isBoolean()) {
                return null;
            }
            return json.getAsJsonPrimitive(key)
                .getAsBoolean();
        }
    }
}
