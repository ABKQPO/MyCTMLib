...
public final class PipelineInfo {
    ...
    public enum PipelineType {
        ...
        MODEL,
        /** 新管线 TextureRegistry 分支：iconName → ConnectingTextureData/RandomTextureData */
        TEXTURE_REGISTRY,
    ...
    private PipelineInfo(PipelineType type, String iconName, String modelId, String textureKey, ConnectingLayout layout,
        int mask, int randomIndex, String skipReason) {
        this.type = type;
    ...
    public static PipelineInfo model(String iconName, String modelId, String textureKey, ConnectingLayout layout,
        int mask) {
        return new PipelineInfo(PipelineType.MODEL, iconName, modelId, textureKey, layout, mask, -1, null);
    }

    public static PipelineInfo modelRandom(String iconName, String modelId, String textureKey, int randomIndex) {
        return new PipelineInfo(PipelineType.MODEL, iconName, modelId, textureKey, null, -1, randomIndex, null);
    }

    public static PipelineInfo textureRegistry(String iconName, ConnectingLayout layout, int mask) {
        return new PipelineInfo(PipelineType.TEXTURE_REGISTRY, iconName, null, null, layout, mask, -1, null);
    }

    public static PipelineInfo textureRegistryRandom(String iconName, int randomIndex) {
        return new PipelineInfo(PipelineType.TEXTURE_REGISTRY, iconName, null, null, null, -1, randomIndex, null);
    }

    public static PipelineInfo legacy(String iconName) {
        return new PipelineInfo(PipelineType.LEGACY, iconName, null, null, null, -1, -1, null);
    }

    public static PipelineInfo vanilla(String iconName, String skipReason) {
        return new PipelineInfo(PipelineType.VANILLA, iconName, null, null, null, -1, -1, skipReason);
    }
    ...
    /** 随机索引，仅 RandomTextureData 时使用，否则为 -1。 */
